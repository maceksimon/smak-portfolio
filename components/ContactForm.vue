      ...
      <div class="col-span-8">
        ...
        <div class="mt-1">
          <textarea
            ...
            name="message"
            rows="3"
            class="block w-full rounded-md border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-inset focus:ring-violet-500 dark:border-gray-500 dark:bg-gray-700 dark:text-white sm:text-sm"
          />
        </div>
      </div>
    </div>
