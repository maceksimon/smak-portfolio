...
A lightweight Nuxt template to build a MDCSlot driven website, based on [Nuxt Content](https://content.nuxtjs.org), [TailwindCSS](https://tailwindcss.com) and [Iconify](https://iconify.design) :sparkles:
...
- [Document-Driven Mode](https://content.nuxtjs.org/guide/writing/document-driven)
  ...
  - Create pages in MDCSlot in the `content/` directory
  - Use Nuxt layouts in your MDCSlot pages
  - Enjoy meta tag generation from MDCSlot files
  - Generated navigation based on your pages
    ::
- Switch between Light & Dark mode :moon:
- Access 100,000 icons from 100+ icon sets with the `<Icon>` component
- Highlight code blocks with [Shiki](https://shiki.matsu.io)
- Create Vue components and use them in your MDCSlot
...
Create your MDCSlot pages in the `content/` directory:
...
You can also use it in your MDCSlot:
...
Add Vue components into the `components/content/` directory and start using them in MDCSlot.
...
By leveraging the [`<ContentSlot>`](https://content.nuxtjs.org/api/components/markdown) component from Nuxt Content, you can use both slots and props in MDCSlot thanks to the [MDC syntax](https://content.nuxtjs.org/guide/writing/mdc).
